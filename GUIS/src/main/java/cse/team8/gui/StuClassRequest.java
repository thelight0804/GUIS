 ...
 * @author User
 */
public class StuClassRequest extends javax.swing.JFrame {

    /**
     * Creates new form StuClassRequest
     */
    public StuClassRequest() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StuClassRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StuClassRequest().setVisible(true);
            }
        });
    }
