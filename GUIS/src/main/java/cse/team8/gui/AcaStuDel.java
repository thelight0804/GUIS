 ...
 * @author User
 */
public class AcaStuDel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("삭제할 학생을 검색해주세요");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcaStuDel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
