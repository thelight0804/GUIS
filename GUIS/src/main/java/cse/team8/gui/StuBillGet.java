 ...
 * @author User
 */
public class StuBillGet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jListClassInfo.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "class 1", "class 2", "class 3", "class 4", "class 5", " " };
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StuBillGet().setVisible(true);
            }
        });
    }
